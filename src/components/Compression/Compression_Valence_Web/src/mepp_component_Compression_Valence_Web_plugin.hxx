#ifndef HEADER_MEPP_COMPONENT_COMPRESSION_VALENCE_WEB_PLUGIN_INTERFACE_H
#define HEADER_MEPP_COMPONENT_COMPRESSION_VALENCE_WEB_PLUGIN_INTERFACE_H
...
/**
 \class	mepp_component_Web_Compression_Valence_plugin

 \brief	Mepp component compression valence web plugin. 

 */

class mepp_component_Compression_Valence_Web_plugin : 
  public QObject,
  public mepp_component_plugin_interface
{
	...
	public:
		...
		/**
		 \fn	mepp_component_Compression_Valence_Web_plugin()
		
		 \brief	Default constructor.

		 */

		mepp_component_Compression_Valence_Web_plugin() : mepp_component_plugin_interface() {}
		...
		~mepp_component_Compression_Valence_Web_plugin()
		{
			delete actionCompress; delete actionOpen_P3DW_file; delete actionDecompress_all;
		...
		void init(mainwindow* mainWindow, QList<QMdiSubWindow *> lw)
		{
			...
			actionOpen_P3DW_file = new QAction(tr("Open P3DW file"), this);
			if (actionOpen_P3DW_file)
				connect(actionOpen_P3DW_file, SIGNAL(triggered()), this, SLOT(load_P3DW_file()));
		...
		/**
		 \fn	void mepp_component_Compression_Valence_Web_plugin::OnCompress();
		...
		/**
		 \fn	void load_P3DW_file();
		
		 \brief	Loads the p3dw file.
