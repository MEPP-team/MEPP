...
sudo apt-get update
sudo apt-get install filezilla subversion unrar libcgal-dev qtcreator libqglviewer-qt4-dev g++ cmake-gui
...
se positionner dans trunk, puis,
 ...
 - pour une version Release: cmake .. (exécuter 2 fois de suite cette commande) puis make
 - pour une version Debug: cmake .. -DCMAKE_BUILD_TYPE=Debug (exécuter 2 fois de suite cette commande) puis make
